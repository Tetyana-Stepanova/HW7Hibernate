...
public class SkillDeleteCommand implements Command {
    ...
    public void process(HttpServletRequest req, HttpServletResponse resp, TemplateEngine engine) throws IOException {
        ...
        if (method.equals("POST") && req.getParameter("deleteId") != null){
            ...
            String error = "";
            try {
                error = skillService.deleteById(Integer.parseInt(id));
            }catch (Exception e) {
                error = e.getMessage();
            }
        ...
        engine.process("skill-delete", simpleContext, resp.getWriter());
